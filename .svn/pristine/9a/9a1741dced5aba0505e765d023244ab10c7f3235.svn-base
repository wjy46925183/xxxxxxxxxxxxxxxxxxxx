 ...
 * 作者：wangdakuan
 * 主要功能：有关数组处理的工具类。
 * 创建时间：2016/12/22 12:36
 */
public class ArrayUtil {
    /**
     * 空实例化 <code>Object</code> array.
     */
    public static final Object[] EMPTY_OBJECT_ARRAY = new Object[0];
    /**
     * 空实例化 <code>Class</code> array.
     */
    public static final Class[] EMPTY_CLASS_ARRAY = new Class[0];
    /**
     * 空实例化 <code>String</code> array.
     */
    public static final String[] EMPTY_STRING_ARRAY = new String[0];
    /**
     * 空实例化<code>long</code> array.
     */
    ...
    /**
     * 空实例化<code>int</code> array.
     */
    public static final int[] EMPTY_INT_ARRAY = new int[0];
    /**
     * 空实例化<code>Integer</code> array.
     */
    public static final Integer[] EMPTY_INTEGER_OBJECT_ARRAY = new Integer[0];
    /**
     * 空实例化<code>short</code> array.
     */
    ...
    /**
     * 空实例化<code>char</code> array.
     */
    public static final char[] EMPTY_CHAR_ARRAY = new char[0];
    /**
     * 空实例化<code>Character</code> array.
     */
    public static final Character[] EMPTY_CHARACTER_OBJECT_ARRAY = new Character[0];

    /**
     * 当在列表或数组中没有找到一个元素的索引值: <code>-1</code>.
     * 此值是由在此类方法返回，并也可在比较与由返回的值被用于
     * {@link java.util.List}.
     */
...
//    }
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>给定的数组转换为{@link的java.util.Map}。该数组的每个元素
     *必须是{@link Map.Entry}或数组，其中包含至少两个
     *元件，其中第一元件用作密钥和第二为
     *值。</p>
     *
