...
public class HomeUrl {
     ...
     * 选择需求订单
     */
    public static final String SELECT_ORDER = UrlNet.getName()+"/api/jobTaskRest/getJobTaskAskByEmployeeId";
    /**
     * 预约
     */
    public static final String SUBSCRIBE_ORDER = UrlNet.getName()+"/api/jobServiceRest/saveJobTask";
    /**
     * 服务详情
     */
    public static final String SERVICE_DETAIL = UrlNet.getName() + "/api/jobServiceRest/findById";
    /**
     * 分享服务
     */
