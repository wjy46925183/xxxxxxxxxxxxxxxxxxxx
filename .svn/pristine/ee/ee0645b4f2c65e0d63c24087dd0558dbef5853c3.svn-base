...
public class UmengShareUtil {
    ...
    public ShareAction initShareAction(final String title, final String content, final String url, final String logoUrl) {
        mShareAction = initShareAction(title, content, url, logoUrl, SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE,
     ...
     * @return
     */
    public ShareAction initShareAction(final String title, final String content, final String url, final String logoUrl, SHARE_MEDIA... list) {
        mShareAction = new ShareAction((Activity) mContext).setDisplayList(list)
