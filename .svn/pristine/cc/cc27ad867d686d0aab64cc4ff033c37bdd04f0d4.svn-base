 ...
 * 创建时间：2017/6/1 12:44
 */
public class IncHomeToolBarHelper extends IncBaseBarHelper {
    ...
    public IncHomeToolBarHelper(Context context) {
        super(context);
    }

    public IncHomeToolBarHelper(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IncHomeToolBarHelper(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public IncHomeToolBarHelper(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        super.initToolBar();
        mToolBarView = mInflater.inflate(R.layout.inc_toolbar_title_home_view, this);
...
//        }
     ...
     * @param listener
     */
    public void setToolbarRightIamgOnClickListener(View.OnClickListener listener) {
        if(null != toolbarRightIamg){
     ...
     * @param listener
     */
    public void setToolbarLeftIamgeOnClickListener(View.OnClickListener listener) {
        if(null != toolbarLeftIamge){
