package com.common.view.swipemenulistview;
...
public class SwipeMenuListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void init() {
        ...
        mFooterView = LayoutInflater.from(getContext()).inflate(R.layout.progress_item,this,false);
        mFooterView.findViewById(R.id.end).setVisibility(GONE);
        mFooterView.findViewById(R.id.tv_loading).setVisibility(VISIBLE);
        mFooterView.findViewById(R.id.pb).setVisibility(VISIBLE);
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        //得到ListView的底部坐标减去底部padding值，也就是显示内容最底部的坐标
        int listBottom = getBottom() - getPaddingBottom();

        if(this.getLastVisiblePosition() == this.getAdapter().getCount() - 1&&lastChildBottom == listBottom
