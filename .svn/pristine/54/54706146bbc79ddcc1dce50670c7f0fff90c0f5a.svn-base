...
public class HirerHomeFragment extends BaseFragment implements View.OnClickListener,
        TabLayout.OnTabSelectedListener, DictionaryPresenter, HirerMapPresenter,
        DlgMapView.OnCameraChangeFinish, ViewPager.OnPageChangeListener, HirerDoingPresenter {
    ...
    private EmployeeCardAdapter mCardAdapter; //卡片适配器
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_hirerhome, null);
        initView(inflate);
        initData();
        return inflate;
    }
    ...
    private void initListener() {
         ...
         */
        mMapView.setClickMarkerItem(false, new DlgMapView.ClickMarker() {
            @Override
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_list) {//列表
            ...
            String address = MApp.getInstance().getAddress();
