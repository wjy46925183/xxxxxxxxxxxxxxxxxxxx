 ...
 */
public class IncNewAlertViewAdapter extends BaseAdapter {
    private List<String> mDatas;
    private String mDestructive;
    private boolean isCenter = false;

    public IncNewAlertViewAdapter(List<String> datas, String destructive, boolean isCenter) {
        this.mDatas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.inc_item_alertdialog, null);
