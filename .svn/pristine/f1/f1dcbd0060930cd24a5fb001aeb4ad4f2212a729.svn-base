...
//                .doOnNext(saveToCacheAction(HomeUrl.BOSS_IS_TASKING_LIST+ JSON.toJSONString(hashMap)))
    ...
    public Observable<JsonResponse<String>> selectOrder(HashMap<String, String> hashMap) {
        return OkGo.post(HomeUrl.SELECT_ORDER)
                .params(hashMap)
    ...
    public Observable<JsonResponse<String>> subscribeService(HashMap<String, String> hashMap) {
        return OkGo.post(HomeUrl.SUBSCRIBE_ORDER)
                .params(hashMap)
                .getCall(new JsonConvert<JsonResponse<String>>() {
                }, RxAdapter.<JsonResponse<String>>create())
                .observeOn(AndroidSchedulers.mainThread());
    ...
    public Observable<JsonResponse<List<ServiceListDataBean>>> serviceDetail(HashMap<String, String> hashMap) {
        return OkGo.post(HomeUrl.SERVICE_DETAIL)
                .params(hashMap)
    ...
    public Observable<JsonResponse<List<ServiceShareBean>>> shareService(HashMap<String, String> hashMap) {
        return OkGo.post(HomeUrl.SHARE_SERVICE)
                .params(hashMap)
                .getCall(new JsonConvert<JsonResponse<List<ServiceShareBean>>>() {
                }, RxAdapter.<JsonResponse<List<ServiceShareBean>>>create())
                .observeOn(AndroidSchedulers.mainThread());
    }

    @Override
    public Observable<JsonResponse<List<OddJobMarketBean>>> getOddJobMarket(HashMap<String, String> hashMap) {
        return OkGo.post(HomeUrl.ODD_JOB_MARKET)
                .params(hashMap)
                .getCall(new JsonConvert<JsonResponse<List<OddJobMarketBean>>>() {
                }, RxAdapter.<JsonResponse<List<OddJobMarketBean>>>create())
                .observeOn(AndroidSchedulers.mainThread());
    }
