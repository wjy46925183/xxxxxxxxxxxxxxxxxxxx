...
import gongren.com.dlg.adapter.AlertViewAdapter;
import gongren.com.dlg.adapter.NewAlertViewAdapter;
import gongren.com.dlg.utils.AlertAnimateUtil;
...
public class AlertView {
     ...
     * @return
     */
    public AlertView setView(boolean isZDY, boolean isChildCenter,String selectStr) {
        ...
        if (isZDY) {
            ...
            view = (ViewGroup) inflater.inflate(R.layout.choose_picture_dialog, null);
        }
...
//                params.setMargins(margin_alert_left_right, 0, margin_alert_left_right, margin_alert_left_right);//原来的。
    ...
    protected void initMyListView() {
        ...
        NewAlertViewAdapter adapter = new NewAlertViewAdapter(mDatas, selectStr, isChildCenter);
        alertButtonListView.setAdapter(adapter);
        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
