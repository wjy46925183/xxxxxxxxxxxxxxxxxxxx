 ...
 */
public class IncTextOrEditxtView extends LinearLayout {
    ...
    public IncTextOrEditxtView(Context context) {
        super(context);
        this.mContext = context;
    }

    public IncTextOrEditxtView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initAttribute(attrs);
    }

    public IncTextOrEditxtView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public IncTextOrEditxtView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initAttribute(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.inc_TextOrEditxtView);
        try {
            mLeftText = a.getString(R.styleable.inc_TextOrEditxtView_inc_leftText );
            mLeftTextColor = a.getColor(R.styleable.inc_TextOrEditxtView_inc_leftTextColor, DEFAULT_TIPS_TEXT_COLOR);
            mLeftTextSize = a.getDimension(R.styleable.inc_TextOrEditxtView_inc_leftTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, DEFAULT_TIPS_TEXT_SIZE, getResources().getDisplayMetrics()));

            mRightText = a.getString(R.styleable.inc_TextOrEditxtView_inc_rightText);
            mRightTextColor = a.getColor(R.styleable.inc_TextOrEditxtView_inc_rightTextColor, DEFAULT_TIPS_TEXT_COLOR);
            mRightTextSize = a.getDimension(R.styleable.inc_TextOrEditxtView_inc_rightTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, DEFAULT_TIPS_TEXT_SIZE, getResources().getDisplayMetrics()));

            mRightHintText = a.getString(R.styleable.inc_TextOrEditxtView_inc_rightHintText);
            mRightTextHintColor = a.getColor(R.styleable.inc_TextOrEditxtView_inc_rightTextHintColor, DEFAULT_TIPS_TEXT_COLOR);
            mRightTextHintSize = a.getDimension(R.styleable.inc_TextOrEditxtView_inc_rightTextHintSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, DEFAULT_TIPS_TEXT_SIZE, getResources().getDisplayMetrics()));
            mRightTextPaddingRight = a.getDimensionPixelOffset(R.styleable.inc_TextOrEditxtView_inc_rightTextPaddingRight, 0);
            maxLength = a.getInteger(R.styleable.inc_TextOrEditxtView_inc_maxLength, 100000);

            mBottomDivider = a.getBoolean(R.styleable.inc_TextOrEditxtView_inc_bottomDivider, true);
            mIsEnabled = a.getBoolean(R.styleable.inc_TextOrEditxtView_inc_isEnabled, true);
            mIsNumber = a.getBoolean(R.styleable.inc_TextOrEditxtView_inc_isNumber, false);
        } finally {
            a.recycle();
        }
        initView();
    ...
    private void initView() {
        ...
        View view = inflater.inflate(R.layout.inc_view_text_or_editxt, this);
