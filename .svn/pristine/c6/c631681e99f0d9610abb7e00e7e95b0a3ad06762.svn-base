...
public class WheelView extends View {
	...
	// The number of first item_find_lv in layout
	...
	/**
	 * Sets the current item_find_lv. Does nothing when index is wrong.
	 * 
	 * @param index the item_find_lv index
	...
	/**
	 * Sets the current item_find_lv w/o animation. Does nothing when index is wrong.
	 * 
	 * @param index the item_find_lv index
	 */
	...
	/**
	 * Tests if wheel is cyclic. That means before the 1st item_find_lv there is shown the last one
	...
	/**
	 * Returns height of wheel item_find_lv
	 * @return the item_find_lv height
	 */
	...
	/**
	 * Creates item_find_lv layouts if necessary
	 */
	...
	/**
	 * Adds view for item_find_lv to items layout
	 * @param index the item_find_lv index
	 * @param first the flag indicates if view should be first
	 * @return true if corresponding item_find_lv exists and is added
	 */
	 ...
	 * @param index the item_find_lv index
	 * @return true if item_find_lv index is not out of bounds or the wheel is cyclic
	 */
	...
	/**
	 * Returns view for specified item_find_lv
	 * @param index the item_find_lv index
	 * @return item_find_lv view or empty view if index is out of bounds
	 */
