...
public class UserDiaskSource implements UserInteractor {
    ...
    @Override
    public Observable<JsonResponse<String>> upUserInfo(HashMap<String, String> hashMap) {
    ...
    public Observable<JsonResponse<String>> upUserInfoMain(HashMap<String, String> hashMap) {
        return this.objectCache.get(UserUrl.UPDATE_USER_INFORMATION_MAIN + JSON.toJSONString(hashMap), JsonResponse.class, String.class);
    }
    ...
    public Observable<JsonResponse<List<UserNameBean>>> isVerify(HashMap<String, String> hashMap) {
        return this.objectCache.get(UserUrl.NAME_VERIFY_BY_PHOTO + JSON.toJSONString(hashMap), JsonResponse.class, UserNameBean.class);
    }
    ...
    public Observable<JsonResponse<List<UserUpHeadBean>>> upLoadHead(HashMap<String, String> hashMap) {
        return this.objectCache.get(UserUrl.UPDATE_USER_HEAD + JSON.toJSONString(hashMap), JsonResponse.class, UserUpHeadBean.class);
    }
