package com.dlg.personal.user.view;
...
import com.common.wheeView.OnWheelScrollListener;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
	...
	public
	ChangeAddressPopwindow(final Context context) {
		super(context);
		this.context = context;
		View view=View.inflate(context, R.layout.view_change_address_pop,null);
...
//		this.setAnimationStyle(R.style.AnimBottom);
	...
	private class AddressTextAdapter extends AbstractWheelTextAdapter1 {
		...
		protected AddressTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
			super(context, R.layout.item_province_city_area, NO_RESOURCE, currentItem, maxsize, minsize);
			this.list = list;
