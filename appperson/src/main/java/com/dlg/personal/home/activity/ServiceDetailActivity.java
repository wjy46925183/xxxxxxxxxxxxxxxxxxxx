...
public class ServiceDetailActivity extends BaseActivity implements View.OnClickListener, ServiceDetailPersenter, ShareServicePresenter {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tv_share) {//分享
            if (mShareAction != null) {
                ...
                ServiceShareViewModel serviceShareViewModel = new ServiceShareViewModel(this, this);
                serviceShareViewModel.shareService(mItemBean.getId());
            }
    ...
    public void shareService(List<ServiceShareBean> serviceShareBeen) {
        ...
        mShareAction = UmengShareUtil.Builder(this).initListener().initShareAction(serviceShareBean.getServiceTitle()
                , serviceShareBean.getServiceDescription(), serviceShareBean.getDetailsUrl(),
                serviceShareBean.getUserLogo());
        mShareAction.open();
    }
