...
public class EmployeeCardFragment extends BaseFragment implements WorkCardPresenter,
    ...
    private GrabSingleOrderPresenter mGrabSingleOrderPresenter; //抢单接口
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.tv_active) { //抢单
            if(null == mOrderViewModel){
                mOrderViewModel = new GrabSingleOrderViewModel(mActivity,this,mGrabSingleOrderPresenter);
            }
            if(null != mHomeMapListBean){
                mOrderViewModel.grabSingleOrder(mHomeMapListBean.getId());
            }
    ...
    public void setGrabSingleOrderPresenter(GrabSingleOrderPresenter singleOrderPresenter){
        this.mGrabSingleOrderPresenter = singleOrderPresenter;
    }
