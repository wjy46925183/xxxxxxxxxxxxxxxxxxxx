 ...
 */
public class WalletDetailListAdapter extends BaseLoadMoreHeaderAdapter<WalletListBean> {

    public WalletDetailListAdapter(Context mContext, RecyclerView recyclerView, List<WalletListBean> invoiceListBean, int mLayoutId) {
    ...
    public void convert(Context mContext, RecyclerView.ViewHolder holder, int position, WalletListBean invoiceListBean) {
        if (holder instanceof BaseViewHolder){
            ...
            String[] tradeTypes = mContext.getResources().getStringArray(R.array.wallet_list_trade_type);
            ...
            String[] paymentTypes = mContext.getResources().getStringArray(R.array.payment_type);
