...
import com.dlg.personal.oddjob.adapter.CancleOrderAdapter;
 ...
 * 作者：王进亚
 * 主要功能：取消订单
 * 创建时间：2017/7/10 10:29
 */

public class CancelOrderFrament extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView(View view) {
        ...
        CancleOrderAdapter cancleOrderAdapter =
                new CancleOrderAdapter(mActivity, mRecyclerView, mListBeen, R.layout.item_doing_hire);
        mRecyclerView.setAdapter(cancleOrderAdapter);

        mSwipeRefresh.setColorSchemeColors(getResources().getColor(R.color.orange_yellow));
        mSwipeRefresh.setOnRefreshListener(this);

        cancleOrderAdapter.setOnItemClickListener(new BaseLoadMoreHeaderAdapter.OnItemClickListener() {
            @Override
