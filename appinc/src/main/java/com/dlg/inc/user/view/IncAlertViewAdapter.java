 ...
 */
public class IncAlertViewAdapter extends BaseAdapter {
    private List<String> mDatas;
    private List<String> mDestructive;

    public IncAlertViewAdapter(List<String> datas, List<String> destructive) {
        this.mDatas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.inc_item_alertbutton, null);
