 ...
 */
public class IncHomeTypeView extends LinearLayout implements View.OnClickListener {
    ...
    public IncHomeTypeView(Context context) {
        super(context);
        init();
    }

    public IncHomeTypeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public IncHomeTypeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public IncHomeTypeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.inc_view_home_type, this);
