...
public class IncWalletDetailDetailActivity extends IncBaseActivity implements WalletDetailDetailPresenter {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setContentView(R.layout.inc_page_wallet_detail_detail, IncToolBarType.Default);
	...
	private void setTextView(WalletListDetailBean bean) {
		...
		String tradeTypeStr = "";
		String[] stringArray = getResources().getStringArray(R.array.inc_wallet_list_trade_type);
