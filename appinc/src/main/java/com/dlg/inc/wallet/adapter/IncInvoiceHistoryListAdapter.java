 ...
 */
public class IncInvoiceHistoryListAdapter extends BaseLoadMoreHeaderAdapter<BillHistoryBean> {

    public IncInvoiceHistoryListAdapter(Context mContext, RecyclerView recyclerView, List<BillHistoryBean> invoiceListBean, int mLayoutId) {
