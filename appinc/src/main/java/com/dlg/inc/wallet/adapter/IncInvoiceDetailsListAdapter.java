 ...
 */
public class IncInvoiceDetailsListAdapter extends BaseLoadMoreHeaderAdapter<BillDetailListBean> {

    public IncInvoiceDetailsListAdapter(Context mContext, RecyclerView recyclerView, List<BillDetailListBean> invoiceListBean, int mLayoutId) {
