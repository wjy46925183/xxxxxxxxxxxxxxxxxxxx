...
public class IncDlgMapView extends TextureMapView {
    private AMap mAMap;
    ...
    public IncDlgMapView(Context context) {
        super(context);
        initDlgMap();
    }

    public IncDlgMapView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        initDlgMap();
    }

    public IncDlgMapView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        initDlgMap();
    }

    public IncDlgMapView(Context context, AMapOptions aMapOptions) {
    ...
    public void setItemsMulti(List<LatLng> latlngs) {
        ...
        View view = View.inflate(getContext(), R.layout.inc_item_map_small, null);
    ...
    public void setSmallLastMarker(boolean isGuYuan) {
        if (isGuYuan) {
            ...
            if (bigLastMarker != null) {
                ...
                final View view = View.inflate(getContext(), R.layout.inc_item_map_hire_img, null);
    ...
    public void setBigMarker(boolean isGuYuan, int zIndex) {
        ...
        if (isGuYuan) {
            final View newView = View.inflate(getContext(), R.layout.inc_item_map_big, null);
            ...
            if (clickedPosition != -1) {
                final View view = View.inflate(getContext(), R.layout.inc_item_map_small, null);
            ...
            final View bossView = View.inflate(getContext(), R.layout.inc_item_map_hire_big, null);
